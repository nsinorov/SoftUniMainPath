...
namespace Skeleton.Tests
{
    ...
    public class AxeTests
    {
        ...
        [Test]
        public void Axe_ConstructorShouldSetDataProperly()
        {
        ...
        [Test]
        public void Axe_AttackShouldThrowException_WhenDurabilityIs0()
        {
            axe = new Axe(10, 0);
        ...
        [Test]
        public void Axe_AttackShouldThrowException_WhenDurabilityIsNegative()
        {
            axe = new Axe(10, -5);
