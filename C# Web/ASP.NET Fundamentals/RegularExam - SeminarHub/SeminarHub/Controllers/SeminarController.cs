...
namespace SeminarHub.Controllers
{
    public class SeminarController : Controller
    {
        ...
        public async Task<IActionResult> Join(int id)
        {
            ...
            if (!await _context.SeminarParticipants.ContainsAsync(seminarParticipant))
            {
        ...
        {
            var seminarParticipant = await _context.SeminarParticipants
        ...
        public async Task<IActionResult> Joined()
        {
            ...
            var seminars = await _context.SeminarParticipants
